    ...
    return(
      <div className="row mb-2">
        <div className="col-12 col-md-9">
          <select value={this.state.address} className="form-control form-control-sm" id={`addressSelect${this.props.id}`} onChange={this.onAddressChange}>
            <option></option>
        ...
        <div className="col-12 col-md-3">
          <input type="number" className="form-control form-control-sm" value={this.state.amount} id={`amount${this.props.id}`}  onChange={this.onAmountChange}/>
        </div>
      </div>
    )
  }
